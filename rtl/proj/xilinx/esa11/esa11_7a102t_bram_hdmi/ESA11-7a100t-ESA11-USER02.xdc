# BaseBoard = ESA11-7a100t AddOn =  ESA11-USER02
...
set_property -dict {PACKAGE_PIN M16 IOSTANDARD LVTTL DRIVE 4} [get_ports {M_EXPMOD0[2]}]
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVTTL DRIVE 4} [get_ports {M_EXPMOD0[3]}]
