...
-- Module  Version: 5.2
--/usr/local/diamond/1.1/ispfpga/bin/lin/scuba -w -n pcm_pll -lang vhdl -synth synplify -arch mg5a00 -type pll -fin 25 -phase_cntl STATIC -fclkop 250 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -noclkok -norst -noclkok2 -e 

-- Fri Apr 15 15:12:35 2011
...
entity pcm_pll is
 ...
 attribute dont_touch of pcm_pll : entity is true;
end pcm_pll;

architecture Structure of pcm_pll is
...
-- synopsys translate_off
library xp2;
configuration Structure_CON of pcm_pll is
    for Structure
