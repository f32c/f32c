...
-- Module  Version: 5.7
--/usr/local/diamond/3.4_x64/ispfpga/bin/lin64/scuba -w -n pll_100M_433M33 -lang vhdl -synth synplify -arch mg5a00 -type pll -fin 100 -phase_cntl STATIC -fclkop 434 -fclkop_tol 10.0 -fb_mode CLOCKTREE -noclkos -noclkok -norst -noclkok2 

-- Thu Mar 26 17:08:19 2015
...
entity pll_100M_433M33 is
    port (
        CLK: in std_logic; 
        CLKOP: out std_logic; 
        LOCK: out std_logic);
 attribute dont_touch : boolean;
 attribute dont_touch of pll_100M_433M33 : entity is true;
end pll_100M_433M33;

architecture Structure of pll_100M_433M33 is
    ...
    attribute FIN of PLLInst_0 : label is "100.000000";
...
begin
    ...
    PLLInst_0: EPLLD1
        ...
        PHASEADJ=> "0.0", CLKOK_DIV=>  2, CLKOP_DIV=>  2, CLKFB_DIV=>  13, 
        CLKI_DIV=>  3)
        -- synopsys translate_on
...
-- synopsys translate_off
library xp2;
configuration Structure_CON of pll_100M_433M33 is
    for Structure
