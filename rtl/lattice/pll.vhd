...
-- Module  Version: 5.2
--/usr/local/diamond/1.1/ispfpga/bin/lin/scuba -w -n pll -lang vhdl -synth synplify -arch mg5a00 -type pll -fin 25 -phase_cntl STATIC -fclkop 50 -fclkop_tol 0.0 -fb_mode INTERNAL -noclkos -noclkok -norst -noclkok2 -e 

-- Sun Apr  3 09:00:23 2011
...
begin
    ...
    PLLInst_0: EPLLD1
        ...
        PHASEADJ=> "0.0", CLKOK_DIV=>  2, CLKOP_DIV=>  16, CLKFB_DIV=>  2, 
        CLKI_DIV=>  1)
        -- synopsys translate_on
