...
-- Module  Version: 5.7
--/mt/lattice/diamond/3.7_x64/ispfpga/bin/lin64/scuba -w -n clk_100_125_25 -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00m -type pll -fin 100.00 -fclkop 125.00 -fclkop_tol 0.0 -fclkos 125.00 -fclkos_tol 0.0 -phases 180 -fclkos2 25.00 -fclkos2_tol 0.0 -phases2 0 -phase_cntl STATIC -fb_mode 1 -fdc /home/guest/src/fpga/fpgarduino/f32c/rtl/proj/lattice/kondor_ax/xram_acram_emu_vector/clk_100_125_25/clk_100_125_25.fdc 

-- Sun Sep 11 09:54:57 2016
...
entity clk_100_125_25 is
    port (
        CLKI: in  std_logic; -- 100 MHz in
        CLKOP: out  std_logic; -- 125 MHz out
        CLKOS: out  std_logic; -- 125 MHz inverted out
        CLKOS2: out  std_logic); -- 25 MHz out
end clk_100_125_25;

architecture Structure of clk_100_125_25 is
...
begin
    ...
    PLLInst_0: EHXPLLL
        ...
        CLKOS2_CPHASE=>  24, CLKOS_FPHASE=>  4, CLKOS_CPHASE=>  6, 
        ...
        CLKOS2_DIV=>  25, CLKOS_DIV=>  5, CLKOP_DIV=>  5, CLKFB_DIV=>  5, 
