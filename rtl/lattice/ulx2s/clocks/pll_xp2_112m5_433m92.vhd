...
-- Module  Version: 5.7
--/usr/local/diamond/3.4_x64/ispfpga/bin/lin64/scuba -w -n pll_112M5_433M92 -lang vhdl -synth synplify -arch mg5a00 -type pll -fin 112.5 -phase_cntl STATIC -fclkop 433 -fclkop_tol 10.0 -fb_mode CLOCKTREE -noclkos -noclkok -norst -noclkok2 

-- Sun Aug 16 00:59:49 2015
...
entity pll_112M5_433M92 is
 ...
 attribute dont_touch of pll_112M5_433M92 : entity is true;
end pll_112M5_433M92;

architecture Structure of pll_112M5_433M92 is
...
begin
    ...
    PLLInst_0: EPLLD1
        ...
        PHASEADJ=> "0.0", CLKOK_DIV=>  2, CLKOP_DIV=>  2, CLKFB_DIV=>  27, 
        CLKI_DIV=>  7)
        -- synopsys translate_on
...
-- synopsys translate_off
library xp2;
configuration Structure_CON of pll_112M5_433M92 is
    for Structure
