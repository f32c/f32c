...
-- Module  Version: 5.7
--/mt/lattice/diamond/3.7_x64/ispfpga/bin/lin64/scuba -w -n pll_112m5_433m92_72m32 -lang vhdl -synth synplify -arch mg5a00 -type pll -fin 112.5 -phase_cntl STATIC -fclkop 433.92 -fclkop_tol 0.1 -fb_mode CLOCKTREE -noclkos -fclkok 72 -fclkok_tol 1.0 -norst -noclkok2 

-- Mon Sep 26 01:26:01 2016
...
entity pll_112m5_433m92_72m32 is
    port (
        CLK: in std_logic; 
        CLKOP: out std_logic; 
        CLKOK: out std_logic; 
        LOCK: out std_logic);
end pll_112m5_433m92_72m32;

architecture Structure of pll_112m5_433m92_72m32 is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "433.928571";
    ...
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "112.500000";
    attribute FREQUENCY_PIN_CLKOK of PLLInst_0 : label is "72.321429";
    attribute CLKOK_DIV of PLLInst_0 : label is "6";
    attribute CLKOP_DIV of PLLInst_0 : label is "2";
    attribute CLKFB_DIV of PLLInst_0 : label is "27";
    attribute CLKI_DIV of PLLInst_0 : label is "7";
    attribute FIN of PLLInst_0 : label is "112.500000";
...
begin
    ...
    PLLInst_0: EPLLD1
        ...
        PHASEADJ=> "0.0", CLKOK_DIV=>  6, CLKOP_DIV=>  2, CLKFB_DIV=>  27, 
        CLKI_DIV=>  7)
        -- synopsys translate_on
...
-- synopsys translate_off
library xp2;
configuration Structure_CON of pll_112m5_433m92_72m32 is
    for Structure
