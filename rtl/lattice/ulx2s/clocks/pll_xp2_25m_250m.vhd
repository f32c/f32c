...
-- Module  Version: 5.7
--/mt/lattice/diamond/3.6_x64/ispfpga/bin/lin64/scuba -w -n pll_25m_250m -lang vhdl -synth synplify -arch mg5a00 -type pll -fin 25 -phase_cntl STATIC -fclkop 250 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -noclkok -norst -noclkok2 

-- Thu May 12 08:56:03 2016
...
architecture Structure of pll_25m_250m is
...
-- synopsys translate_off
library xp2;
configuration Structure_CON of pll_25m_250m is
    for Structure
