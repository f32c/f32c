...
-- Module  Version: 5.7
--C:\lscc\diamond\3.8_x64\ispfpga\bin\nt64\scuba.exe -w -n clk_100_75 -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00m -type pll -fin 100.00 -fclkop 75 -fclkop_tol 0.0 -phase_cntl STATIC -fb_mode 1 -fdc C:/cygwin64/home/marko/github/f32c/rtl/proj/lattice/kondor_ax/bram/clarity/clk_100_75/clk_100_75.fdc 

-- Thu Sep 29 16:26:33 2016
...
entity clk_100_75 is
    port (
        CLKI: in  std_logic; -- 100 MHz
        CLKOP: out  std_logic -- 75 MHz
    );
end clk_100_75;

architecture Structure of clk_100_75 is
...
begin
    ...
    PLLInst_0: EHXPLLL
        ...
        CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  7, PLL_LOCK_MODE=>  0, 
        ...
        CLKOS2_DIV=>  1, CLKOS_DIV=>  1, CLKOP_DIV=>  8, CLKFB_DIV=>  3, 
