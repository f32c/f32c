...
-- Module  Version: 5.7
--/mt/lattice/diamond/3.7_x64/ispfpga/bin/lin64/scuba -w -n clk_100_150_30 -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00m -type pll -fin 100.00 -fclkop 150.00 -fclkop_tol 0.0 -fclkos 150.00 -fclkos_tol 0.0 -phases 180 -fclkos2 30.00 -fclkos2_tol 0.0 -phases2 0 -phase_cntl STATIC -fb_mode 1 -fdc /home/guest/src/fpga/fpgarduino/f32c/rtl/proj/lattice/kondor_ax/xram_acram_emu_vector/clk_100_150_30/clk_100_150_30.fdc 

-- Sun Sep 11 10:30:41 2016
...
entity clk_100_150_30 is
    port (
        CLKI: in  std_logic; -- 100 MHz
        CLKOP: out  std_logic; -- 150 MHz
        CLKOS: out  std_logic; -- 150 MHz inverted
        CLKOS2: out  std_logic); -- 30 MHz
end clk_100_150_30;

architecture Structure of clk_100_150_30 is
...
begin
    ...
    PLLInst_0: EHXPLLL
        ...
        CLKOS2_DIV=>  20, CLKOS_DIV=>  4, CLKOP_DIV=>  4, CLKFB_DIV=>  3, 
