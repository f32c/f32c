...
-- Module  Version: 5.2
--/usr/local/diamond/1.2/ispfpga/bin/lin/scuba -w -n pll_300m -lang vhdl -synth synplify -arch mg5a00 -type pll -fin 25 -phase_cntl STATIC -fclkop 300 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -noclkok -norst -noclkok2 -e 

-- Mon May  9 23:48:29 2011
...
entity pll_300m is
 ...
 attribute dont_touch of pll_300m : entity is true;
end pll_300m;

architecture Structure of pll_300m is
    ...
    attribute CLKFB_DIV of PLLInst_0 : label is "12";
...
begin
    ...
    PLLInst_0: EPLLD1
        ...
        PHASEADJ=> "0.0", CLKOK_DIV=>  2, CLKOP_DIV=>  2, CLKFB_DIV=>  12, 
        CLKI_DIV=>  1)
        -- synopsys translate_on
...
-- synopsys translate_off
library xp2;
configuration Structure_CON of pll_300m is
    for Structure
