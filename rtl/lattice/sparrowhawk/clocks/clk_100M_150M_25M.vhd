...
-- Module  Version: 5.7
--/mt/lattice/diamond/3.7_x64/ispfpga/bin/lin64/scuba -w -n clk_100M_150M_25M -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 100 -phase_cntl STATIC -fclkop 150 -fclkop_tol 0.0 -fb_mode CLOCKTREE -phaseadj 180.0 -duty 8 -fclkok 25 -fclkok_tol 0.0 -clkoki 0 -norst -noclkok2 -bw 

-- Sun Sep 11 21:27:52 2016
...
entity clk_100M_150M_25M is
    port (
        ...
        CLKOK: out std_logic; 
        LOCK: out std_logic);
end clk_100M_150M_25M;

architecture Structure of clk_100M_150M_25M is
...
begin
    ...
    PLLInst_0: EHXPLLF
        ...
        CLKOK_DIV=>  6, CLKOP_DIV=>  4, CLKFB_DIV=>  3, CLKI_DIV=>  2, 
        FIN=> "100.000000")
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of clk_100M_150M_25M is
    for Structure
