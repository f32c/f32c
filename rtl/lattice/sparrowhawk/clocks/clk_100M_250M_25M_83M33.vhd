...
-- Module  Version: 5.7
--/mt/lattice/diamond/3.7_x64/ispfpga/bin/lin64/scuba -w -n clk_100M_250M_25M_83M33 -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 100 -phase_cntl STATIC -fclkop 250 -fclkop_tol 0.0 -fb_mode CLOCKTREE -phaseadj 180.0 -duty 8 -fclkok 25 -fclkok_tol 0.0 -clkoki 0 -norst -bw 

-- Tue Sep 13 11:07:47 2016
...
entity clk_100M_250M_25M_83M33 is
    port (
        CLK: in std_logic; 
        CLKOP: out std_logic; 
        CLKOS: out std_logic; 
        ...
        LOCK: out std_logic);
end clk_100M_250M_25M_83M33;

architecture Structure of clk_100M_250M_25M_83M33 is
    ...
    attribute FREQUENCY_PIN_CLKOK2 of PLLInst_0 : label is "83.333333";
...
begin
    ...
    PLLInst_0: EHXPLLF
        ...
        CLKOK_DIV=>  10, CLKOP_DIV=>  4, CLKFB_DIV=>  5, CLKI_DIV=>  2, 
        FIN=> "100.000000")
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of clk_100M_250M_25M_83M33 is
    for Structure
