...
-- Module  Version: 5.7
--/mt/lattice/diamond/3.7_x64/ispfpga/bin/lin64/scuba -w -n clkgen -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 25 -fclkop 200 -fclkop_tol 0.0 -fclkos 200 -fclkos_tol 0.0 -fclkos2 40 -fclkos2_tol 0.0 -fclkos3 50 -fclkos3_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 90 -trims_r -phases2 0 -phases3 0 -phase_cntl STATIC -fb_mode 1 

-- Thu Aug 11 10:48:43 2016
...
architecture Structure of clkgen800x600 is
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        PLL_USE_WB=> "DISABLED", CLKOS3_FPHASE=>  0, CLKOS3_CPHASE=>  11, 
        ...
        CLKOP_ENABLE=> "ENABLED", CLKOS3_DIV=>  12, CLKOS2_DIV=>  15, 
        CLKOS_DIV=>  3, CLKOP_DIV=>  3, CLKFB_DIV=>  8, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of clkgen800x600 is
    for Structure
