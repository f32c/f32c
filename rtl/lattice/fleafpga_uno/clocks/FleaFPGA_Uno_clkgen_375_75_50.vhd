...
-- Module  Version: 5.7
--/mt/lattice/diamond/3.7_x64/ispfpga/bin/lin64/scuba -w -n clkgen -lang vhdl -synth synplify -arch xo2c00 -type pll -fin 25 -fclkop 375 -fclkop_tol 0.0 -fclkos 375 -fclkos_tol 0.0 -fclkos2 75 -fclkos2_tol 0.0 -fclkos3 50 -fclkos3_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 90 -trims_r -phases2 0 -phases3 0 -phase_cntl STATIC -fb_mode 1 

-- Thu Aug 25 12:50:51 2016
...
architecture Structure of clkgen_375_75_50 is
    ...
    attribute FREQUENCY_PIN_CLKOS2 of PLLInst_0 : label is "75.000000";
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "375.000000";
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "375.000000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        PLL_USE_WB=> "DISABLED", CLKOS3_FPHASE=>  0, CLKOS3_CPHASE=>  14, 
        CLKOS2_FPHASE=>  0, CLKOS2_CPHASE=>  9, CLKOS_FPHASE=>  4, 
        ...
        CLKOP_ENABLE=> "ENABLED", CLKOS3_DIV=>  15, CLKOS2_DIV=>  10, 
        CLKOS_DIV=>  2, CLKOP_DIV=>  2, CLKFB_DIV=>  15, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
