...
-- Module  Version: 5.7
--/mt/lattice/diamond/3.7_x64/ispfpga/bin/lin64/scuba -w -n clk_25_125p_125n_78_78s -lang vhdl -synth synplify -bus_exp 7 -bb -arch sa5p00 -type pll -fin 25.00 -fclkop 125.00 -fclkop_tol 0.0 -fclkos 125.00 -fclkos_tol 0.0 -phases 180 -fclkos2 78.125 -fclkos2_tol 10.0 -phases2 0 -fclkos3 78.125 -fclkos3_tol 0.0 -phases3 146.25 -phase_cntl STATIC -fb_mode 1 -fdc /home/guest/src/fpga/fpgarduino/f32c/rtl/proj/lattice/fleafpga_ohm/xram_sdram_vector_25f/clk1/clk_25_125p_125n_78_78s/clk_25_125p_125n_78_78s.fdc 

-- Wed Feb 28 19:41:15 2018
...
entity clk_25_125p_125n_78_78s is
    port (
        CLKI: in  std_logic; 
        CLKOP: out  std_logic; 
        CLKOS: out  std_logic; 
...
end clk_25_125p_125n_78_78s;

architecture Structure of clk_25_125p_125n_78_78s is
    ...
    attribute FREQUENCY_PIN_CLKOS3 of PLLInst_0 : label is "78.125000";
    attribute FREQUENCY_PIN_CLKOS2 of PLLInst_0 : label is "78.125000";
...
begin
    ...
    PLLInst_0: EHXPLLL
        ...
        CLKOS3_FPHASE=>  2, CLKOS3_CPHASE=>  10, CLKOS2_FPHASE=>  0, 
        CLKOS2_CPHASE=>  7, CLKOS_FPHASE=>  4, CLKOS_CPHASE=>  6, 
        ...
        CLKOS2_DIV=>  8, CLKOS_DIV=>  5, CLKOP_DIV=>  5, CLKFB_DIV=>  5, 
