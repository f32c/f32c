...
/* XXX cheating defines start */
//#define CHEAT_INLINE
#ifdef CHEAT_INLINE
static void Proc_1 (REG Rec_Pointer);
static void Proc_2 (One_Fifty *);
static void Proc_3 (Rec_Pointer *);
static void Proc_4 (void);
static void Proc_5 (void);
static void Proc_6 (Enumeration, Enumeration *);
static void Proc_7 (One_Fifty, One_Fifty, One_Fifty *);
static void Proc_8 (Arr_1_Dim, Arr_2_Dim, int, int);
static Boolean Func_2 (Str_30, Str_30);
static Boolean Func_3 (Enumeration);
#endif
/* XXX cheating defines end */
